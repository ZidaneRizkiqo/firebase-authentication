...
import { isPasswordValid, isValidEmail, showError } from '../utilities/utilities'
...
function RegisterPage() {
    ...
    const handleFormSubmit = (e) => {
        ...
        register(userDetails.email, userDetails.password)
            .then(res => {
                const session = {
                        ...
                        <div className="md:max-w-md w-full sm:px-6 py-4">
                            <form onKeyUp={handleFormInput} onSubmit={handleFormSubmit}>
                                <div className="mb-12">
                                    ...
                                    <p className="text-sm mt-4 ">Have an account <Link to="/login" className="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Login </Link></p>
                                </div>
                                <div>
                                    <label className="text-xs block mb-2">Email</label>
                                    <div className="relative flex items-center">
                                        <input name="email" type="text" className="w-full text-sm border-b border-gray-300 focus:border-[#333] px-2 py-3 outline-none" placeholder="Enter email" value={userDetails.name} />
                                ...
                                <div className="mt-8">
                                    ...
                                    <div className="relative flex items-center">
                                        <input name="password" type="password" className="w-full text-sm border-b border-gray-300 focus:border-[#333] px-2 py-3 outline-none" placeholder="Enter password" />
